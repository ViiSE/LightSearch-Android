...
public class SettingsViewChangePasswordAlertDialogCreatorDTODefaultImpl implements SettingsViewChangePasswordAlertDialogCreatorDTO {

    private final AlertDialogCreatorDTO alertDialogCreatorDTO;
    private final HashAlgorithm hashAlgorithm;

    public SettingsViewChangePasswordAlertDialogCreatorDTODefaultImpl(
