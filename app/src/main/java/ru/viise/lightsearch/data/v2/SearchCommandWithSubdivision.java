...
public class SearchCommandWithSubdivision implements Command<SearchPojo> {

    private final Command<SearchPojo> command;
    private final String subdivision;

    public SearchCommandWithSubdivision(Command<SearchPojo> command, String subdivision) {
    ...
    public SearchPojo formForSend() {
        ...
        searchPojo.setSubdivision(subdivision);
