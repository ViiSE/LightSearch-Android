...
public class SearchCommandWithBarcode implements Command<SearchPojo> {

    private final Command<SearchPojo> command;
    private final String barcode;

    public SearchCommandWithBarcode(Command<SearchPojo> command, String barcode) {
