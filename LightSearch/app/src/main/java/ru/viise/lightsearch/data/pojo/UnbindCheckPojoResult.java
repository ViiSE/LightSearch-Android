...
public class UnbindCheckPojoResult implements SendForm {
    ...
    @Expose
    private List<UnbindRecord> records;
    ...
    public List<UnbindRecord> getRecords() {
        return records;
    }

    public void setRecords(List<UnbindRecord> records) {
