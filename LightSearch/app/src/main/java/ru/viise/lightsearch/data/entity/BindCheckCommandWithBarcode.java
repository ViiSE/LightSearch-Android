...
public class BindCheckCommandWithBarcode implements Command<BindCheckPojo> {

    private final Command<BindCheckPojo> command;
    private final String barcode;

    public BindCheckCommandWithBarcode(Command<BindCheckPojo> command, String barcode) {
    ...
    public BindCheckPojo formForSend() {
        ...
        bindCheckPojo.setBarcode(barcode);
