...
public class LoginCommandWithModel implements Command<LoginPojo> {

    private final Command<LoginPojo> command;
    private final String model;

    public LoginCommandWithModel(Command<LoginPojo> command, String model) {
