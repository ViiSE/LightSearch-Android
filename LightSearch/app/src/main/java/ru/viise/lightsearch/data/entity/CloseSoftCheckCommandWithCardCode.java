...
public class CloseSoftCheckCommandWithCardCode implements Command<CloseSoftCheckPojo> {

    private final Command<CloseSoftCheckPojo> command;
    private final String cardCode;

    public CloseSoftCheckCommandWithCardCode(Command<CloseSoftCheckPojo> command, String cardCode) {
    ...
    public CloseSoftCheckPojo formForSend() {
        ...
        closeSoftCheckPojo.setCardCode(cardCode);
