...
public class CreatePasswordInFirstTimeAlertDialogCreatorImpl implements CreatePasswordInFirstTimeAlertDialogCreator {
    ...
    public CreatePasswordInFirstTimeAlertDialogCreatorImpl(
    ...
    public AlertDialog create() {
        ...
        dialogSettingsContainer.buttonOK().setOnClickListener(viewOK -> {
            ...
            ed.putString(SUPERUSER,
                    creatorDTO.hashAlgorithms().digest(dialogSettingsContainer.editText().getText().toString()));
