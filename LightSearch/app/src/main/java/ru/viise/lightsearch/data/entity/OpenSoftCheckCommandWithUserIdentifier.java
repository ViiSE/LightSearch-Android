...
public class OpenSoftCheckCommandWithUserIdentifier implements Command<OpenSoftCheckPojo> {

    private final Command<OpenSoftCheckPojo> command;
    private final String userIdentifier;

    public OpenSoftCheckCommandWithUserIdentifier(
    ...
    public OpenSoftCheckPojo formForSend() {
        ...
        openSoftCheckPojo.setUserIdentifier(userIdentifier);
