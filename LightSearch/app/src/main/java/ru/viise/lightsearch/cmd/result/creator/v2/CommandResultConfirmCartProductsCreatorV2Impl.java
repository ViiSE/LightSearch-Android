...
public class CommandResultConfirmCartProductsCreatorV2Impl implements CommandResultCreator {

    private final ConfirmSoftCheckProductsResultPojo pojo;

    public CommandResultConfirmCartProductsCreatorV2Impl(ConfirmSoftCheckProductsResultPojo pojo) {
        this.pojo = pojo;
    }
    ...
    public CommandResult create() {
        if(pojo.getIsDone()) {
            ...
            return ConfirmCartProductsResultInit.confirmCartProductsResult(
                    pojo.getIsDone(),
                    null,
                    cartRecords,
                    null);
