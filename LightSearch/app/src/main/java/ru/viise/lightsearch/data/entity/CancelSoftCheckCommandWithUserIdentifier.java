...
public class CancelSoftCheckCommandWithUserIdentifier implements Command<CancelSoftCheckPojo> {

    private final Command<CancelSoftCheckPojo> command;
    private final String userIdentifier;

    public CancelSoftCheckCommandWithUserIdentifier(
    ...
    public CancelSoftCheckPojo formForSend() {
        ...
        cancelSoftCheckPojo.setUserIdentifier(userIdentifier);
