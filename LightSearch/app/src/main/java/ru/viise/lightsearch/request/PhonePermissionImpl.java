...
public class PhonePermissionImpl implements PhonePermission {

    private final int PHONE_STATE_CODE = 1;
    private final Activity activity;

    public PhonePermissionImpl(Activity activity) {
    ...
    public void requestPhonePermission() {
        if(ActivityCompat.shouldShowRequestPermissionRationale(activity, Manifest.permission.READ_PHONE_STATE) ||
            ...
            RequestPhonePermissionAlertDialogCreator reqPPADCr =
                    new RequestPhonePermissionAlertDialogCreatorImpl(activity);
