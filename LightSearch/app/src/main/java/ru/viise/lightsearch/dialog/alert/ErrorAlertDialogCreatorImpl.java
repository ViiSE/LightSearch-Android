...
public class ErrorAlertDialogCreatorImpl implements ErrorAlertDialogCreator {

    private final Activity rootActivity;
    private final String errorMessage;

    public ErrorAlertDialogCreatorImpl(Activity rootActivity, String errorMessage) {
