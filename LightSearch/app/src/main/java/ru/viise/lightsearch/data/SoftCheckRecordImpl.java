...
public class SoftCheckRecordImpl implements SoftCheckRecord {
    ...
    public SoftCheckRecordImpl(String name, String barcode, String price, String amountUnit,
    ...
    private SoftCheckRecordImpl(Parcel in) {
        name = in.readString();
        barcode = in.readString();
        price = in.readFloat();
        maxAmount = in.readFloat();
        amountUnit = in.readString();
        subdivisions = in.readParcelable(SubdivisionListImpl.class.getClassLoader());
    }
    ...
    public static final Parcelable.Creator<SoftCheckRecord> CREATOR
        ...
        public SoftCheckRecord createFromParcel(Parcel in) {
            return new SoftCheckRecordImpl(in);
        }

        @Override
        public SoftCheckRecord[] newArray(int size) {
            return new SoftCheckRecordImpl[size];
        }
    };
}
