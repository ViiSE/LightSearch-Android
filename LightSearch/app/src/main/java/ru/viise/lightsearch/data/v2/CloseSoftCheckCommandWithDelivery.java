...
public class CloseSoftCheckCommandWithDelivery implements Command<CloseSoftCheckPojo> {

    private final Command<CloseSoftCheckPojo> command;
    private final String delivery;

    public CloseSoftCheckCommandWithDelivery(Command<CloseSoftCheckPojo> command, String delivery) {
    ...
    public CloseSoftCheckPojo formForSend() {
        ...
        closeSoftCheckPojo.setDelivery(delivery);
