...
public class CreatePasswordInFirstTimeAlertDialogCreatorDTODefaultImpl implements CreatePasswordInFirstTimeAlertDialogCreatorDTO {

    private final AlertDialogCreatorDTO alertDialogCreatorDTO;
    private final HashAlgorithm hashAlgorithm;

    public CreatePasswordInFirstTimeAlertDialogCreatorDTODefaultImpl(
