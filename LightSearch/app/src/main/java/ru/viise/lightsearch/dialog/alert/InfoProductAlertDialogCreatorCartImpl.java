...
public class InfoProductAlertDialogCreatorCartImpl implements InfoProductAlertDialogCreator {

    private final Activity activity;
    private final CartRecord record;

    public InfoProductAlertDialogCreatorCartImpl(Activity activity, CartRecord record) {
        this.record = record;
