...
public class LoginCommandWithUserIdentifier implements Command<LoginPojo> {

    private final Command<LoginPojo> command;
    private final String userIdent;

    public LoginCommandWithUserIdentifier(Command<LoginPojo> command, String userIdent) {
    ...
    public LoginPojo formForSend() {
        ...
        loginPojo.setUserIdentifier(userIdent);
