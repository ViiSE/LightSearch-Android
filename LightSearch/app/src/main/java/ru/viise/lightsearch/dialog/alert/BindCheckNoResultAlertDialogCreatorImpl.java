...
public class BindCheckNoResultAlertDialogCreatorImpl implements NoResultAlertDialogCreator {

    private final Activity activity;
    private final String message;

    public BindCheckNoResultAlertDialogCreatorImpl(Activity activity, String message) {
    ...
    public AlertDialog create() {
        ...
        dialogOKContainer.textViewTitle().setText(R.string.dialog_bind_check_no_result_title);
