...
public class CloseSoftCheckCommandWithUserIdentifier implements Command<CloseSoftCheckPojo> {

    private final Command<CloseSoftCheckPojo> command;
    private final String userIdent;

    public CloseSoftCheckCommandWithUserIdentifier(Command<CloseSoftCheckPojo> command, String userIdent) {
    ...
    public CloseSoftCheckPojo formForSend() {
        ...
        closeSoftCheckPojo.setUserIdentifier(userIdent);
