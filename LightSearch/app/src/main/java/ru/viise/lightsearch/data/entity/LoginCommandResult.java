...
public class LoginCommandResult implements CommandResult<LoginPojo, LoginPojoResult> {

    private final LoginPojoResult resultPojo;

    public LoginCommandResult(LoginPojoResult resultPojo) {
    ...
    @Override
    public Command<LoginPojo> lastCommand() {
        return null;
    }
}
