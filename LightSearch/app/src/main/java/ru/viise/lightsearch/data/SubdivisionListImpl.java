...
public class SubdivisionListImpl implements SubdivisionList {

    private final List<Subdivision> subdivisions = new ArrayList<>();
    private final String amountUnit;

    public SubdivisionListImpl(String amountUnit) {
    ...
    private SubdivisionListImpl(Parcel in) {
        amountUnit = in.readString();
        in.readTypedList(subdivisions, SubdivisionImpl.CREATOR);
    }
    ...
    public static final Parcelable.Creator<SubdivisionList> CREATOR
        ...
        public SubdivisionList createFromParcel(Parcel in) {
            return new SubdivisionListImpl(in);
        }
