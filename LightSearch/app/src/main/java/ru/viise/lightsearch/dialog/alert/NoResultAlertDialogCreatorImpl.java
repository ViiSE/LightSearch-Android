...
public class NoResultAlertDialogCreatorImpl implements NoResultAlertDialogCreator {

    private final Activity activity;

    public NoResultAlertDialogCreatorImpl(Activity activity) {
    ...
    public AlertDialog create() {
        ...
        dialogOKContainer.textViewResult().setText(activity.getString(R.string.dialog_no_result));
