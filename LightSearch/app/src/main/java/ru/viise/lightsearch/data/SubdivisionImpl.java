...
public class SubdivisionImpl implements Subdivision {

    private final String name;
    private final float productAmount;

    public SubdivisionImpl(String name, String productAmount) {
        this.name = name;
    ...
    private SubdivisionImpl(Parcel in) {
        name = in.readString();
    ...
    public static final Parcelable.Creator<Subdivision> CREATOR
        ...
        public Subdivision createFromParcel(Parcel in) {
            return new SubdivisionImpl(in);
        }

        @Override
        public Subdivision[] newArray(int size) {
            return new SubdivisionImpl[size];
        }
    };
}
